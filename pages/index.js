...
//       <h2>Discord da Galera!</h2>
//     </div>
//   )
// }

export default function PaginaInicial() {
  //const username = 'franciscoldb';
  const [username, setUsername] = useState('franciscoldb');
    ...
    <>
      <Box
        styleSheet={{
          ...
          backgroundColor: appConfig.theme.colors.primary[450],
      ...
      >
        <Box
          styleSheet={{
            ...
            borderRadius: '30px', padding: '25px', margin: '16px',
